                ...
                <div class="backdrop-blur-xl bg-white/5 rounded-3xl p-6 sm:p-8 border border-white/10 shadow-2xl shadow-black/20">
                    ...
                    <div class="space-y-2.5">
                        ...
                        <div class="relative py-1">
                            ...
                            <div class="relative flex justify-center"><span class="px-2 text-[10px] text-white/20 bg-transparent">SUPER ADMIN</span></div>
                        </div>

                        <button type="button" onclick="loginAs('Super Admin', 'super-admin')"
                            class="w-full flex items-center gap-3 p-3 rounded-xl bg-gradient-to-r from-indigo-500/10 to-emerald-500/10 hover:from-indigo-500/20 hover:to-emerald-500/20 border border-white/10 hover:border-amber-500/50 transition-all duration-200 group active:scale-[0.98]">
                            <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-emerald-500 text-white flex items-center justify-center shrink-0">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z"/></svg>
                            </div>
                            <div class="flex-1 min-w-0 text-left">
                                <p class="text-sm font-semibold text-white/90">Demo Super Admin</p>
                                <p class="text-xs text-white/40">Kontrol RT &amp; Masjid</p>
                            </div>
                            <svg class="w-4 h-4 text-amber-400/50 group-hover:text-amber-400 transition-colors shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z"/></svg>
                        </button>
                    </div>
...
function loginAs(title, role) {
    const email = role === 'masjid' ? 'ketua@masjid.test' : role === 'super-admin' ? 'admin@smarta.test' : 'ketua@rt01.test';
